...
describe("error-handler", () => {
  it("should return 400 when 400-Error was passed to error-handler", async () => {
  ...
  it("should return 404 when 404-Error was passed to error-handler", async () => {
  ...
  it("should return 500 when generic Error was passed to error-handler", async () => {
