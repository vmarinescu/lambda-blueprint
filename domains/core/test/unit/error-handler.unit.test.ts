...
describe("error-handler", () => {
  it("should return 400 when ValidationError was passed to create-handler", async () => {
  ...
  it("should return 500 when Error was passed to create-handler", async () => {
  ...
  it("should return 404 when NotFoundError was passed to get-handler", async () => {
  ...
  it("should return 500 when Error was passed to get-handler", async () => {
